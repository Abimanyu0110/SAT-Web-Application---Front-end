...
//                 <label
//                     htmlFor={name}
//                     className={`text-sm font-medium text-gray-600 ${flex ? "w-1/3" : "w-full"}`}
//                 >
//                     {label} {required && <span className="text-red-500">*</span>}
//                 </label>
//             )}

//             <div className={`flex flex-col ${flex ? "w-2/3" : "w-full"}`}>
//                 {/* Input */}
//                 <input
//                     id={name}
//                     name={name}
...
//           focus:ring-2- disabled:bg-gray-100 text-sm`}
//                 />

//                 {/* Error Message */}
//                 {error && <p className="text-xs mt-0.5 ml-0.5 text-red-500">{error}</p>}
//             </div>
